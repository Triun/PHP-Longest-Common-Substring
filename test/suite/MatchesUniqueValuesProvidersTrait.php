...
trait MatchesUniqueValuesProvidersTrait
{
    public function twoStringsSymmetricMatchesUniqueValuesProvider()
    {
        return [
            'Empty values'                          => [
                '',
    ...
    public function twoStringsOrderedMatchesUniqueValuesProvider()
    {
        return [
            ...
            'Hexadecimal'                     => [
                ...
                ['123456789A', '56789ABCDE'],
            ],
            'Hexadecimal Reverse'             => [
                '56789AB56789ABCDE56789ABCDE56789AB56789A123456789A',
                '0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF',
                ['56789ABCDE', '123456789A'],
            ],
        ];
    }

    public function threeStringsSymmetricMatchesUniqueValuesProvider()
    {
        return [
            'No match'          => [
                'ABDEGH',
